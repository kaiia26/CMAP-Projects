...
remainingAmount5, remainingAmount1 amountLeft;
...
printf("$20 bills: %i", amountNeeded20);  // prints out 4 $20 bills
...
printf("$10 bills: %i", amountNeeded10); // prints out 1 $10 bill
